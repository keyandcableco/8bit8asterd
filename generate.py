  ...
  <section class="section" id="playSection">
    ...
    <div class="module">
      ...
      <div class="bar" style="margin:0 13px 10px;">
        ...
        <span class="label">Chord 8ve</span>
        <div class="oct" id="chordOct"></div>
        <span class="label">Strum 8ve</span>
    ...
    <div class="module">
      ...
      <div class="bar" style="margin:0 13px 10px;">
        ...
        <span class="spacer"></span>
        <span class="label" id="kbRange">C4 &ndash; B5</span>
      </div>
...
function chordFor(){
  ...
  if (!spec) return [];
  const base = ROOTS[activeRoot][1] + (sharpOn ? 1 : 0) + chordOct * 12;
  return spec.tones.map(t => Math.max(24, Math.min(96, base + t)));
}
...
function buildPlaySurface(){
  ...
  makeOctave('chordOct', () => chordOct, v => {
    chordOct = v;
    if (heldRows.size) refreshChord();
  }, -2, 2);
  makeOctave('strumOct', () => strumOct, v => {
    strumOct = v;
    if (heldRows.size) strumNotes = ladderFor();
  }, -1, 2);
